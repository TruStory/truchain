...
func ErrCommunityNotFound(slug string) sdk.Error {
	return sdk.NewError(DefaultCodespace, ErrorCodeCommunityNotFound, fmt.Sprintf("Community not found with slug: %s", slug))
}
