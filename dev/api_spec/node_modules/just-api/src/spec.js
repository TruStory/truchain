...
class Spec {
    ...
    _validateJSONData(response, jsonData) {
        ...
        for (let eachJsonData of jsonData) {
            ...
            if ((0, _utils.isNumber)(eachJsonData.value) || eachJsonData.value.constructor.name === 'String') {
                ...
                throw new Error(`Unknown json data value type, only Array, Object, RegExp, Number & String are allowed`);
            }
        }
